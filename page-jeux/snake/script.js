...
function speedUpdate (){
   updateSpeed = setInterval(()=>{    label.innerText=`vitesse du serpent (10 par defaut) : ${vitesse.value}`;SPEED=vitesse.value},75)
}
...
vitesse.addEventListener("focus",speedUpdate) //Lorsqu'on est entrain de changer la vitesse, on met a jour le label et la vitesse
vitesse.addEventListener("focusout",stopSpeedUpdate); //Lorsqu'on est plus entrain de changer la vitesse, on arrete de mettre a jour le label et la vitesse
